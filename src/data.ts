...
export const CONTRIBUTORS: Contributor[] = [
  { id: 'davidc', name: 'David Chen', ini: 'DC', col: '#5E8C7B', avatarUrl: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=200&h=200&q=80', church: 'Grace Community Church', doc: 'Reformed', loc: 'Los Angeles', focus: ['Adults'], notes: 7, followers: 88, bio: 'Capturing sound doctrine and sung worship, one service at a time.', ver: false },
  { id: 'mark', name: 'Rev. Mark Thompson', ini: 'MT', col: '#6B7B5E', avatarUrl: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&w=200&h=200&q=80', church: 'City Light Cathedral', doc: 'Charismatic', loc: 'Los Angeles', focus: ['Adults'], notes: 42, followers: 540, bio: 'Preaching Christ-centred purpose for over 20 years.', ver: true },
  { id: 'olumide', name: 'Olumide Adebayo', ini: 'OA', col: '#B0713A', avatarUrl: 'https://images.unsplash.com/photo-1506277886164-e25aa3f4ef7f?auto=format&fit=crop&w=200&h=200&q=80', church: 'The Elevation Church', doc: 'Pentecostal', loc: 'Lagos', focus: ['Teens'], notes: 22, followers: 320, bio: 'Youth minister raising bold, Scripture-rooted teenagers.', ver: false },
  { id: 'edward', name: 'Rev. Edward Sterling', ini: 'ES', col: '#4E6E8E', avatarUrl: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=200&h=200&q=80', church: 'Holy Trinity Brompton (HTB)', doc: 'Anglican', loc: 'London', focus: ['Adults'], notes: 17, followers: 290, bio: 'Alpha host. Writes on hospitality and everyday evangelism.', ver: true },
  { id: 'blessing', name: 'Blessing Okonjo', ini: 'BO', col: '#8E5E7E', avatarUrl: 'https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?auto=format&fit=crop&w=200&h=200&q=80', church: 'Daystar Christian Centre', doc: 'Pentecostal', loc: 'Lagos', focus: ['Kids'], notes: 18, followers: 245, bio: 'Children’s pastor making big truths simple for little hearts.', ver: true },
  { id: 'hannah', name: 'Hannah Morales', ini: 'HM', col: '#5E7B8C', avatarUrl: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=200&h=200&q=80', church: 'Bethel Church', doc: 'Charismatic', loc: 'Redding', focus: ['Adults'], notes: 12, followers: 215, bio: 'Worshipper and writer on the presence of God.', ver: false },
  { id: 'austin', name: 'Austin Wright', ini: 'AW', col: '#7A6A54', avatarUrl: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?auto=format&fit=crop&w=200&h=200&q=80', church: 'The Village Church', doc: 'Reformed', loc: 'Dallas', focus: ['Adults'], notes: 14, followers: 195, bio: 'Expository notes, verse by verse.', ver: false },
  { id: 'maria', name: 'Maria Santos', ini: 'MS', col: '#A85A4E', avatarUrl: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?auto=format&fit=crop&w=200&h=200&q=80', church: 'Grace Christian Church', doc: 'Non-denominational', loc: 'Manila', focus: ['Kids', 'Teens'], notes: 26, followers: 180, bio: 'Curriculum writer for next-gen ministries.', ver: false },
  { id: 'samuel', name: 'Samuel Kariuki', ini: 'SK', col: '#4E7A6A', avatarUrl: 'https://images.unsplash.com/photo-1522529599102-193c0d76b5b6?auto=format&fit=crop&w=200&h=200&q=80', church: 'Nairobi Chapel', doc: 'Non-denominational', loc: 'Nairobi', focus: ['Adults', 'Teens'], notes: 15, followers: 150, bio: 'Kingdom, culture and marketplace discipleship.', ver: true },
  { id: 'sarah', name: 'Sarah Jenkins', ini: 'SJ', col: '#7A8B6F', avatarUrl: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?auto=format&fit=crop&w=200&h=200&q=80', church: 'Grace Community Church', doc: 'Reformed', loc: 'Los Angeles', focus: ['Adults'], notes: 9, followers: 120, bio: 'Note-taking member — capturing revelation every Sunday.', ver: false },
  { id: 'david', name: 'David Okafor', ini: 'DO', col: '#3E5E56', avatarUrl: 'https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?auto=format&fit=crop&w=200&h=200&q=80', church: 'Reality LA', doc: 'Baptist', loc: 'Los Angeles', focus: ['Teens'], notes: 11, followers: 98, bio: 'Campus minister. Sermon notes for students.', ver: false },
  { id: 'abena', name: 'Abena Mensah', ini: 'AM', col: '#8E7A3A', avatarUrl: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=200&h=200&q=80', church: 'ICGC Christ Temple', doc: 'Pentecostal', loc: 'Accra', focus: ['Kids'], notes: 8, followers: 76, bio: 'Sunday school teacher and memory-verse enthusiast.', ver: false },
  { id: 'ruth', name: 'Ruth Simmons', ini: 'RS', col: '#6A5E8E', avatarUrl: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=200&h=200&q=80', church: 'Riverside Church Sydney', doc: 'Methodist', loc: 'Sydney', focus: ['Adults'], notes: 6, followers: 60, bio: 'Lectionary reflections and quiet-day notes.', ver: false },
];
...
export const INITIAL_DEVOS: Devo[] = [
  { id: 'd1', by: 'hannah', title: 'First Light', scr: 'Psalm 5:3', text: '“In the morning, Lord, you hear my voice…” Before the day gets a word in, give God the first word.', time: '2h', amen: 41, bg: 0, img: 'https://images.unsplash.com/photo-1507692049790-de58290a4334?auto=format&fit=crop&w=600&q=80' },
  { id: 'd2', by: 'hannah', title: 'Oil Before Crowns', scr: '1 Samuel 16:13', text: 'David was anointed long before he was crowned. What God pours in private, He crowns in public.', time: '2h', amen: 38, bg: 3, img: 'https://images.unsplash.com/photo-1499209974431-9dddcece7f88?auto=format&fit=crop&w=600&q=80' },
  { id: 'd3', by: 'olumide', title: 'Morning Fire', scr: 'Leviticus 6:12', text: 'The fire on the altar had to be kept burning every morning. Grace lit it — discipleship keeps it.', time: '4h', amen: 57, bg: 4, img: 'https://images.unsplash.com/photo-1518495973542-4542c06a5843?auto=format&fit=crop&w=600&q=80' },
  { id: 'd4', by: 'samuel', title: 'Daily Manna', scr: 'Exodus 16:21', text: 'Manna melted with the morning sun. Some mercies are only collected early. Wake. Gather. Worship.', time: '6h', amen: 29, bg: 2, img: 'https://images.unsplash.com/photo-1470246973918-29a93221c455?auto=format&fit=crop&w=600&q=80' },
  { id: 'd5', by: 'davidc', title: 'Scan the Skies First', scr: 'Psalm 143:8', text: '“Let the morning bring me word of your unfailing love.” Check the heavens before the headlines.', time: '8h', amen: 33, bg: 1, img: 'https://images.unsplash.com/photo-1509114397022-ed747cca3f65?auto=format&fit=crop&w=600&q=80' },
  { id: 'd6', by: 'blessing', title: 'Little Feet, Big Steps', scr: 'Proverbs 22:6', text: 'Start children on the way they should go — one morning at a time. Today with your kids: Mark 10:14.', time: '9h', amen: 21, bg: 0, img: 'https://images.unsplash.com/photo-1476820865390-c52aeebb9891?auto=format&fit=crop&w=600&q=80' },
  { id: 'd7', by: 'ruth', title: 'Still Waters First', scr: 'Psalm 23:2', text: 'He makes me lie down — rest is appointed, not earned. Begin today from rest, not for it.', time: '12h', amen: 18, bg: 5, img: 'https://images.unsplash.com/photo-1439853941329-a99ce049f08c?auto=format&fit=crop&w=600&q=80' },
];
